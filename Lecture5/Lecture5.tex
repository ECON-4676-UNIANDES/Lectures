...
\item  $M_{e_j} X$ is X with the {\it j column} replaced by zeros
\end{itemize}
...
\begin{itemize}
  ...
  \item $\hat h_t$ related to x coordinate $\rightarrow$ if $h_j$ is large, we have a high leverage
\end{itemize}
...
\begin{frame}
\frametitle{Applications: Leverage}
Case of $y=\alpha + \beta x _u$ (ISLR)
